    ...
    if (! color_profile && frame->config)
      {
        if (gimp_babl_format_get_base_type (frame->sample_format) == GIMP_GRAY)
          color_profile = gimp_color_config_get_gray_color_profile (frame->config,
                                                                    NULL);
        else
          color_profile = gimp_color_config_get_rgb_color_profile (frame->config,
                                                                   NULL);
      }
